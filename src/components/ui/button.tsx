...
// Função buttonVariants para compatibilidade com calendar.tsx
function buttonVariants(props?: { variant?: keyof typeof buttonVariantsConfig.variants.variant; size?: keyof typeof buttonVariantsConfig.variants.size }) {
  const variant = props?.variant || buttonVariantsConfig.defaultVariants.variant
  const size = props?.size || buttonVariantsConfig.defaultVariants.size
  return cn(
